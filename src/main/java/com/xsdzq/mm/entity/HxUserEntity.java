...
public class HxUserEntity implements Serializable {
	...
	public HxUserEntity(Long id, String clientId, String clientName, String fundAccount, String accessToken,
	...
	public String toString() {
		return "HxUserEntity [id=" + id + ", clientId=" + clientId + ", clientName=" + clientName + ", fundAccount="
				...
				+ ", uuid=" + uuid + ", createtime=" + createtime + ", modifytime=" + modifytime + "]";
	}
