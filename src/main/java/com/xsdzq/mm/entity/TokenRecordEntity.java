...
@Entity
@Table(name = "lcj_2021_818_token_record")
...
public class TokenRecordEntity implements Serializable {
	 ...
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sequence_lcj_token_record_2021")
	@SequenceGenerator(name = "sequence_lcj_token_record_2021", sequenceName = "sequence_lcj_token_record_2021", allocationSize = 1)
	@Column(name = "id")
	private long id;
