...
public class PrizeResultRepositoryImpl implements PrizeResultWrapper {
	...
	public PrizeResultEntity getLatestRealPrizeResult() {
	    ...
	    //oracle
		String sql ="select * from (select r.* from lcj_518_2022_prize_result r, lcj_518_2022_prize_info i where r.prize_id = i.id and i.type = 1 order by r.record_time desc) where rownum = 1";
